...
for marker in ["01 · HERO", "02 · WHY THE EXCHANGE", "03 · INTERVIEW SERIES",
               "04 · WHAT MOVES THROUGH THE EXCHANGE", "05 · UNIVERSITIES",
...
for phrase in [
    ...
    "The Exchange gives that",
    "Go beyond the biography.",
    "Bring The Exchange into the room.",
    "Experience should not disappear inside the people who earned it.",
    "The Exchange goes beyond the screen.",
...
for cta in ["Enter The Exchange", "Partner with us", "Join The Exchange",
            "Bring The Exchange to campus", "Be considered as a guest",
            "Explore partnerships", "Explore experiences", "Explore coaching"]:
    check(f"CTA · {cta}", cta in home)

# ── 10 · launch state retires itself ───────────────────────────────────────
check("coming-soon shortcode present", 'tae_coming_soon until="feature"' in home)
check("featured module present", '[tae_interviews view="featured"]' in home)
...
check("email capture is the #join anchor the CTAs point at",
      'id="join"' in home and 'href="#join"' in home)
...
for phrase in [
    ...
    "Sponsor an interview. Nominate a leader. Build something meaningful with The Exchange.",
]:
...
for phrase in [
    "Bring The Exchange to your campus.",
    ...
    "The classroom builds knowledge. The Exchange brings students closer to the people who have lived the decisions, changes and challenges behind it.",
...
check("get-involved hero", "How do you want to enter The Exchange?" in gi)
ROUTES = [("Share your perspective", "/guests-partners/#guest"),
          ("Partner with The Exchange", "/guests-partners/#corporate"),
          ("Bring The Exchange to campus", "/universities/#enquire"),
...
check("preview home renders the coming-soon card",
      '<div class="soon">' in idx and idx.count('<div class="soon">') == 1)
